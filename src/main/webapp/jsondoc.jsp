...
<div class="navbar navbar-fixed-top navbar-inverse">
    <div class="navbar-inner">
        <div class="container-fluid">
            <a class="brand" href="#">CareDoc</a>

            <form class="navbar-form pull-left">
                <input id="jsondocfetch" class="span5" type="text" placeholder="Insert here the JSONDoc URL"
                       autocomplete="on"/>
    ...
    <div class="accordion" id="accordion">
        ...
        <div class="accordion-group">
            <div class="accordion-heading">
                ...
                <a href="#_{{jsondocId}}" id="{{jsondocId}}" rel="method" data-parent="#accordion"
                   data-toggle="collapse" class="accordion-toggle">{{path}}</a>
            </div>
        ...
        <div class="span12">
            <div id="headers">
                ...
                <div class="input-prepend">
                    <span style="text-align:left;" class="add-on span4">{{name}}</span><input type="text" class="span8"
                                                                                              name="{{name}}"
                                                                                              placeholder="{{name}}">
                </div>
                {{/headers}}
...
//                                printResponse(, res, this.url);

                                $("#response").text(JSON.stringify(JSON.parse(method.response.sample), undefined, 2));
